...
function ReverseFeatures({ title, description }) {
  return (
    <div className="flex bg-[#081A26] text-white p-6 sm:p-8 rounded-lg flex-col sm:flex-row w-3/4"> 

      <div className="w-full pb-8 md:pb-0 sm:w-1/2 flex justify-center items-center mt-4 sm:mt-0 pr-0 md:pr-8">
        <img src="public\landscape2.jpg" alt="Feature Image" className="max-w-full h-auto" /> 
      </div>

      <div className="w-full sm:w-3/4 sm:pl-8 sm:border-l border-gray-600"> 
...
export default ReverseFeatures;