const DemoSection = () => (
  <div className="w-full flex justify-center">
    <div className="w-full bg-[#201c33] rounded-2xl shadow-2xl border-2 border-[#7c6cfb]/40 p-0 mb-12 max-w-[900px] mx-auto">
      {/* Chrome tab bar */}
      ...
      <div className="w-full px-6 pb-6">
        <div className="w-full rounded-xl bg-[#6c5dd3]/40 flex items-center justify-center aspect-[16/9]">
